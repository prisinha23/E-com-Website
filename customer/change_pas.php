...
if(isset($_POST['update'])){
    ...
    $check_old_pass=mysqli_num_rows($run_q);//if both pass and email matches then
    if($check_old_pass==0){
    ...
    if($new_password!=$c_n_password){
        echo "<script>alert('Your confirm password does not match with entered password')</script>";
        exit();
    }
