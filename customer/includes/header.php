 <div class="offercolumn"><!------header navbar start---------->
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a href="#" class="btn btn-success btn-sm" style="text-align:center;">
    ...
    <ul class="nav navbar-nav  navbar-right">
      ...
      <li><a href="../../../ecom/cart.php">Go To Cart</a></li>
      <li>
      <?php
          if(!isset($_SESSION['customer_email'])){
              echo "<a href='checkout.php'>Login</a>";//if a person is not logged in
          }else {
              echo "<a href='../../../ecom/logout.php'>Logout</a>";
          }
          ?>  
      </li>
  ...
  <div class="container-fluid">
   ...
   <a class="navbar-brand" href="../../index.php">
    ...
    <ul class="nav navbar-nav">
      <li><a href="../../../ecom/index.php">Home</a></li>
      ...
      <li><a href="../../../ecom/aboutus.php">About Us</a></li>
